# Sleeping detection dataset 3100 images with annotations supports VOC and YOLOF formats.

# Body

Sleeping detection dataset, 3100 images, with annotations, supports VOC and Yolo formats, enhances sleeping and lying down scenes.
Purchase and download the files immediately after purchase, suitable for friends who need to monitor sleep data
